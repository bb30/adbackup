...
fn test_help() {
    ...
    let mocked_message = "adbackup 0.1.0\nJulian Raufelder <julian.raufelder@htwg-konstanz.\
        ...
        Start backup of device\n    devices    List connected devices\n    pull       Pull \
        file/folder from android into current folder of your pc\n    push       Push file/folder \
        from the pc to a connected android device\n    apps       List all installed apps on \
